...
#define YdbStorageBinlogModifyInV2Writer(fid,rfid)  \
    ydb_storage_binlog_write(g_ydb_storage_binlog,\
            YDB_STORAGE_LOG_MODIFY_IN_V2,fid,rfid)

#define YdbStorageBinlogModifyToV1Writer(fid,rfid)  \
    ydb_storage_binlog_write(g_ydb_storage_binlog,\
            YDB_STORAGE_LOG_MODIFY_TO_V1,fid,rfid)
