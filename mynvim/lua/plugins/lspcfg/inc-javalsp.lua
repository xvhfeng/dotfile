local jdtls_path = "/root/.local/share/nvim/mason/packages/jdtls/"
...
local config = {
    cmd = {
        ...
        "-Xbootclasspath/a:" .. jdtls_path .. "lombok.jar",
        "-jar",
        ...
        "-data",
        vim.g.HOME_PATH .. "/.local/workspace"
    },
...
local java_on_attach = function(client, bufnr)
    ...
    --vim.keymap.set('n', '<C-j>', '<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>', opts)
    vim.keymap.set("n", "<S-C-j>", "<cmd>lua vim.lsp.diagnostic.goto_next()<CR>", opts)
