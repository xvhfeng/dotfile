...
plugin.core = {
    ...
    -- opt_marker = "git的diff在vim中的展现。",
    -- opt_enable = true,

    dependencies = "nvim-lua/plenary.nvim",
    cmd = {'DiffviewLog', 'DiffviewOpen', 'DiffviewClose', 'DiffviewRefresh', 'DiffviewFocusFiles',
           'DiffviewFileHistory', 'DiffviewToggleFiles'},
