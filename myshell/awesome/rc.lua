...
awful.key({modkey}, "Return", function() awful.spawn(terminal) end,
          {description = "open a terminal", group = "launcher"}),
                              ...
                              awful.key({altkey}, "space",
                                        function() awful.spawn(rofi_cmd) end, {
...
clientkeys = gears.table.join(awful.key({modkey}, "f", function(c)
    ...
    c:move_to_screen() -- send to other screen
    ...
    c:move_to_screen(c.screen.index + 1)
end, {description = "move to screen right", group = "client"}), awful.key(
                                  {modkey, altkey}, "l",
                                  function() awful.util.spawn(i3cmd) end),
...
end), -- awful.key({ modkey,altkey}, "l", function() 
